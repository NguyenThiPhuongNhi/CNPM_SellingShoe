        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-product">
              <img class="img-fluid resize" src="../../../img/product/Nu/Sandal/s7.png" alt="">
              <div class="product-details">
                <a href="single-product-s7.jsp"><h6>Sandal Nữ Biti's SFW716880DEN (Đen)</h6></a>
                <div class="price">
                  <h6>388.000đ</h6>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-product">
              <img class="img-fluid resize" src="../../../img/product/Nu/Sandal/s8.png" alt="">
              <div class="product-details">
                <a href="single-product-s8.jsp"><h6>Sandal Nữ Biti's DTW010388KEM (Kem)</h6></a>
                <div class="price">
                  <h6>319.000đ</h6>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-product">
              <img class="img-fluid resize" src="../../../img/product/Nu/Sandal/s9.png" alt="">
              <div class="product-details">
                <a href="single-product-s9.jsp"><h6>Sandal crystals Gucci</h6></a>
                <div class="price">
                  <h6>4.000.000đ</h6>
                  <!--                  <h6 class="l-through">210.000đ</h6>-->
                </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-product">
              <img class="img-fluid resize" src="../../../img/product/Nu/Sandal/s10.png" alt="">
              <div class="product-details">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-product">
              <img class="img-fluid resize" src="../../../img/product/Nu/Sandal/s11.png" alt="">
              <div class="product-details">
                <a href="single-product-s11.jsp"><h6>Adilette sandal đen trắng Addidas</h6></a>
                <div class="price">
                  <h6>700.000đ</h6>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-product">
              <img class="img-fluid resize" src="../../../img/product/Nu/Sandal/s12.png" alt="">
              <div class="product-details">
                <a href="single-product-s12.jsp"><h6>Adilette sandal đen xám Addidas</h6></a>
                <div class="price">
                  <h6>700.000đ</h6>
