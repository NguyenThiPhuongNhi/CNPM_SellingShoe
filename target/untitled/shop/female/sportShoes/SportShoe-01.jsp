			...
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						...
						<a href="SportShoe-01.jsp">Giày thể thao nữ</a>
					</nav>
				</div>
			</div>
		</div>
				...
				<div class="sidebar-categories">
					...
					<ul class="main-categories">
						...
						<li class="main-nav-list"><a data-toggle="collapse" href="#" aria-expanded="false" aria-controls="homeClean"><span
								 class="lnr lnr-arrow-right"></span>Giày búp bê<span class="number">(53)</span></a>
			...
			<div class="col-xl-9 col-lg-8 col-md-7">
				...
				<div class="filter-bar d-flex flex-wrap align-items-center">
					...
					<div class="pagination">
						<a href="SportShoe-01.jsp" class="active">1</a>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid resize" src="../../../img/product/Nu/SportShoes/sp1.png" alt="">
								<div class="product-details">
									<a href="single-product-sp1.jsp"><h6>Giày Thể Thao Nữ Êmbrace DSW066300XAD (Xám Đậm)</h6></a>
									<div class="price">
										<h6>549.000đ</h6>
<!--										<h6 class="l-through">378.000đ</h6>-->
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid resize" src="../../../img/product/Nu/SportShoes/sp2.png" alt="">
								<div class="product-details">
									<a href="single-product-sp2.jsp"><h6>Giày Thể Thao Nữ Êmbrace DSW066400HOG (Hồng)</h6></a>
									<div class="price">
										<h6>568.000đ</h6>
<!--										<h6 class="l-through">378.000đ</h6>-->
									</div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid resize" src="../../../img/product/Nu/SportShoes/sp3.png" alt="">
								<div class="product-details">
									<a href="single-product-sp3.jsp"><h6>Giày Thể Thao Nữ Êmbrace DSW066400XDG (Xanh Dương)</h6></a>
									<div class="price">
										<h6>568.000đ</h6>
<!--										<h6 class="l-through">358.000đ</h6>-->
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid resize" src="../../../img/product/Nu/SportShoes/sp4.png" alt="">
								<div class="product-details">
									<a href="single-product-sp4.jsp"><h6>Giày Thể Thao Nữ Biti’s Êmbrace - Blush Pink DSW075400HOL (Hồng Lợt)</h6></a>
									<div class="price">
										<h6>529.000đ</h6>
<!--										<h6 class="l-through">358.000đ</h6>-->
									</div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid resize" src="../../../img/product/Nu/SportShoes/sp5.png" alt="">
								<div class="product-details">
									<a href="single-product-sp5.jsp"><h6>Giày Thể Thao Nữ Biti’s Êmbrace - Raven Black DSW075400DEN (Đen)</h6></a>
									<div class="price">
										<h6>529.000đ</h6>
									</div>
									<div class="prd-bottom">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid resize" src="../../../img/product/Nu/SportShoes/sp6.png" alt="">
								<div class="product-details">
									<a href="single-product-sp6.jsp"><h6>Giày Thể Thao Nữ Biti’s Êmbrace - Creamy White DSW075400KEM (Kem)</h6></a>
									<div class="price">
										<h6>529.000đ</h6>
