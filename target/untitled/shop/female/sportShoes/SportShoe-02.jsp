        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-product">
              <img class="img-fluid resize" src="../../../img/product/Nu/SportShoes/sp7.png" alt="">
              <div class="product-details">
                <a href="single-product-sp7.jsp"><h6>Giày Thể Thao Nữ MWC - 0735 Vải siêu êm chân đế bằng (Xám)</h6></a>
                <div class="price">
                  <h6>295.000đ</h6>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-product">
              <img class="img-fluid resize" src="../../../img/product/Nu/SportShoes/sp8.png" alt="">
              <div class="product-details">
                <a href="single-product-sp8.jsp"><h6>Giày Thể Thao Nữ MWC - 0734 Vải siêu êm chân đế bằng (Cam)</h6></a>
                <div class="price">
                  <h6>295.000đ</h6>
<!--                  <h6 class="l-through">210.000đ</h6>-->
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-product">
              <img class="img-fluid resize" src="../../../img/product/Nu/SportShoes/sp9.png" alt="">
              <div class="product-details">
                <a href="single-product-sp9.jsp"><h6>Giày Thể Thao Nữ MWC - 0736 Vải siêu êm chân đế bằng (Hồng)</h6></a>
                <div class="price">
                  <h6>295.000đ</h6>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-product">
              <img class="img-fluid resize" src="../../../img/product/Nu/SportShoes/sp10.png" alt="">
              <div class="product-details">
                <a href="single-product-sp10.jsp"><h6>Adidas superstar shoes</h6></a>
                <div class="price">
                  <h6>1.499.000đ</h6>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-product">
              <img class="img-fluid resize" src="../../../img/product/Nu/SportShoes/sp11.png" alt="">
              <div class="product-details">
                <a href="single-product-sp11.jsp"><h6>Adidas NMD_V3 shoes</h6></a>
                <div class="price">
                  <h6>2.700.000đ</h6>
<!--                  <h6 class="l-through">751.000đ</h6>-->
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-product">
              <img class="img-fluid resize" src="../../../img/product/Nu/SportShoes/sp12.png" alt="">
              <div class="product-details">
                <a href="single-product-sp12.jsp"><h6>Puma giày thể thao mẫu 2021</h6></a>
                <div class="price">
                  <h6>2.300.000đ</h6>
                  <!--										<h6 class="l-through">210.000đ</h6>-->
                </div>
