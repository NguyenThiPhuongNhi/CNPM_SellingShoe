                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid resize" src="../../img/product/Nu/Boots/cngn.png" alt="">
                            <div class="product-details">
                                <a href="single-product-b7.jsp"><h6>Boots nữ cổ ngắn gót nhỏ(Đen)</h6></a>
                                <div class="price">
                                    <h6>430.000đ</h6>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid resize" src="../../img/product/Nu/Boots/3k.png" alt="">
                            <div class="product-details">
                                <a href="single-product-b8.jsp"><h6>Boots nữ cổ ngắn gót vuông 3 khuy(Đen)</h6></a>
                                <div class="price">
                                    <h6>560.200đ</h6>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid resize" src="../../img/product/Nu/Boots/cnmn.png" alt="">
                            <div class="product-details">
                                <a href="single-product-b9.jsp"><h6>Boots nữ cổ ngắn mũi nhọn(Nâu)</h6></a>
                                <div class="price">
                                    <h6>440.000đ</h6>
                                    <h6 class="l-through">502.000đ</h6>
                                </div>
                                <div class="prd-bottom">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid resize" src="../../img/product/Nu/Boots/cndt.png" alt="">
                            <div class="product-details">
                                <a href="single-product-b10.jsp"><h6>Boots nữ cổ ngắn đế thấp(Đen)</h6></a>
                                <div class="price">
                                    <h6>350.000đ</h6>
                                </div>
                                <div class="prd-bottom">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid resize" src="../../img/product/Nu/Boots/cndtkk.png" alt="">
                            <div class="product-details">
                                <a href="single-product-b11.jsp"><h6>Boots nữ cổ ngắn đế thấp khóa kéo(Đen)</h6></a>
                                <div class="price">
                                    <h6>330.000đ</h6>
                                </div>
                                <div class="prd-bottom">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid resize" src="../../img/product/Nu/Boots/martin.png" alt="">
                            <div class="product-details">
                                <a href="single-product-b12.jsp"><h6>Martin cổ cao đế bảng(Đen)</h6></a>
                                <div class="price">
                                    <h6>680.000đ</h6>
