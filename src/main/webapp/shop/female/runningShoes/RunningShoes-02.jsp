        ...
        <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
            <div class="col-first">
                ...
                <nav class="d-flex align-items-center">
                    ...
                    <a href="../../Nu/Boots/Boots1.jsp">Nữ<span class="lnr lnr-arrow-right"></span></a>
                    <a href="RunningShoes-01.jsp">giày chạy bộ  - đi bộ</a>
                </nav>
            </div>
        </div>
    </div>
        ...
        <div class="col-xl-9 col-lg-8 col-md-7">
            ...
            <div class="filter-bar d-flex flex-wrap align-items-center">
                ...
                <div class="pagination">
                    <a href="RunningShoes-01.jsp">1</a>
                    <a href="RunningShoes-02.jsp" class="active">2</a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid resize" src="../../img/product/Nu/RunningShoes/rs7.png" alt="">
                            <div class="product-details">
                                <a href="single-product-rs7.jsp"><h6>Giày Chạy Bộ Nữ Skechers Go Run Ride 9</h6></a>
                                <div class="price">
                                    <h6>2.303.000đ</h6>
                                    <h6 class="l-through">3.290.000đ</h6>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid resize" src="../../img/product/Nu/RunningShoes/rs8.png" alt="">
                            <div class="product-details">
                                <a href="single-product-rs8.jsp"><h6>Giày Chạy Bộ Nữ Nike Air Zoom Pegasus 39</h6></a>
                                <div class="price">
                                    <h6>3.719.000đ</h6>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid resize" src="../../img/product/Nu/RunningShoes/rs9.png" alt="">
                            <div class="product-details">
                                <a href="single-product-rs9.jsp"><h6>Giày Chạy Bộ Nữ Nike Renew Run 3</h6></a>
                                <div class="price">
                                    <h6>2.499.000đ</h6>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid resize" src="../../img/product/Nu/RunningShoes/rs10.png" alt="">
                            <div class="product-details">
                                <a href="single-product-rs10.jsp"><h6>Giày Chạy Bộ Nữ Nike Pegasus Trail 2</h6></a>
                                <div class="price">
                                    <h6>2.297.400đ</h6>
                                    <h6 class="l-through">3.820.000đ</h6>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid resize" src="../../img/product/Nu/RunningShoes/rs11.png" alt="">
                            <div class="product-details">
                                <a href="single-product-rs11.jsp"><h6>ADISTAR 1 REFUEL SHOES</h6></a>
                                <div class="price">
                                    <h6>3.482.000đ</h6>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid resize" src="../../img/product/Nu/RunningShoes/rs12.png" alt="">
                            <div class="product-details">
                                <a href="single-product-rs12.jsp"><h6>4DFWD PULSE 2 SHOES</h6></a>
                                <div class="price">
                                    <h6>3.482.000đ</h6>
                                    <!--										<h6 class="l-through">210.000đ</h6>-->
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6 mb-20">
                        <div class="single-related-product d-flex">
                            <a href="#"><img src="../../img/product/Nu/Boots/chelsea%20boots.png" alt="" class="resize-img"></a>
                            <div class="desc">
        ...
        <div class="row">
            <div class="col-lg-3  col-md-6 col-sm-6">
                <div class="single-footer-widget">
                    <h6>Theo dõi chúng tôi trên các nên tảng</h6>
                    <p></p>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a  href="../../../checkout.jsp"><button type="button" class="btn btn-primary" style="background-color: #ffba00">Thanh toán</button></a>
            </div>
        </div>
    </div>
</div>
