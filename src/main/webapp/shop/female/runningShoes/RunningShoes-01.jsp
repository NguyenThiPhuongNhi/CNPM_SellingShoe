        ...
        <div class="col-xl-9 col-lg-8 col-md-7">
            ...
            <div class="filter-bar d-flex flex-wrap align-items-center">
                ...
                <div class="pagination">
                    <a href="RunningShoes-01.jsp" class="active">1</a>
                    <a href="RunningShoes-02.jsp">2</a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid resize" src="../../img/product/Nu/RunningShoes/rs1.png" alt="">
                            <div class="product-details">
                                <a href="single-product-rs1.jsp"><h6>Giày Chạy Bộ Nữ New Balance 420 Cushioned</h6></a>
                                <div class="price">
                                    <h6>1.695.000đ</h6>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid resize" src="../../img/product/Nu/RunningShoes/rs2.png" alt="">
                            <div class="product-details">
                                <a href="single-product-rs2.jsp"><h6>Giày Thể Thao Nữ Adidas Duramo 10</h6></a>
                                <div class="price">
                                    <h6>1.360.000đ</h6>
                                    <!--										<h6 class="l-through">378.000đ</h6>-->
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid resize" src="../../img/product/Nu/RunningShoes/rs3.png" alt="">
                            <div class="product-details">
                                <a href="single-product-rs3.jsp"><h6>Giày Chạy Bộ Nữ Biti's Hunter Running Black
                                    DSWH08300DEN (Đen)</h6></a>
                                <div class="price">
                                    <h6>997.500đ</h6>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid resize" src="../../img/product/Nu/RunningShoes/rs4.png" alt="">
                            <div class="product-details">
                                <a href="single-product-rs4.jsp"><h6>Giày Chạy Bộ Nữ Biti's Hunter Running Electric
                                    Blue DSWH03900XDG (Xanh Dương)</h6></a>
                                <div class="price">
                                    <h6>997.500đ</h6>
                                    <h6 class="l-through">1.050.000đ</h6>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid resize" src="../../img/product/Nu/RunningShoes/rs5.png" alt="">
                            <div class="product-details">
                                <a href="single-product-rs5.jsp"><h6>Giày Chạy Bộ Nữ Biti's Hunter Running Neon Green
                                    DSWH03900XMN (Xanh Mi Nơ)</h6></a>
                                <div class="price">
                                    <h6>997.500đ</h6>
                                    <h6 class="l-through">1.050.000đ</h6>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid resize" src="../../img/product/Nu/RunningShoes/rs6.png" alt="">
                            <div class="product-details">
                                <a href="single-product-rs6.jsp"><h6>Giày Chạy Bộ Nữ Biti's Hunter Running White
                                    DSWH08300TRG (Trắng)</h6></a>
                                <div class="price">
                                    <h6>997.500đ</h6>
                                    <h6 class="l-through">1.050.000đ</h6>
                                </div>
