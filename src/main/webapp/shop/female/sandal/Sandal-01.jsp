		...
		<div class="col-xl-9 col-lg-8 col-md-7">
			...
			<div class="filter-bar d-flex flex-wrap align-items-center">
				...
				<div class="pagination">
					<a href="Sandal-01.jsp" class="active">1</a>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-product">
							<img class="img-fluid resize" src="../../../img/product/Nu/Sandal/s1.png" alt="">
							<div class="product-details">
								<a href="single-product-s1.jsp"><h6>Sandal Nữ Êmbrace Black DPW071200DEN (Đen)</h6></a>
								<div class="price">
									<h6>421.000đ</h6>
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-product">
							<img class="img-fluid resize" src="../../../img/product/Nu/Sandal/s2.png" alt="">
							<div class="product-details">
								<a href="single-product-s2.jsp"><h6>Sandal Nữ Biti's Hunter Orange Tonic DEWH00400CAM (Cam)</h6></a>
								<div class="price">
									<h6>452.200đ</h6>
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-product">
							<img class="img-fluid resize" src="../../../img/product/Nu/Sandal/s3.png" alt="">
							<div class="product-details">
								<a href="single-product-s3.jsp"><h6>Sandal Eva Phun Nữ Biti's Hunter DEWH01200DEN (Đen)</h6></a>
								<div class="price">
									<h6>452.000đ</h6>
									<!--										<h6 class="l-through">210.000đ</h6>-->
								</div>
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-product">
							<img class="img-fluid resize" src="../../../img/product/Nu/Sandal/s4.png" alt="">
							<div class="product-details">
								<a href="single-product-s4.jsp"><h6>Sandal Eva Phun Nữ Biti's Hunter REWH00100XDL (Xanh Dương Lợt)</h6></a>
								<div class="price">
									<h6>500.000đ</h6>
									<!--										<h6 class="l-through">210.000đ</h6>-->
								</div>
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-product">
							<img class="img-fluid resize" src="../../../img/product/Nu/Sandal/s5.png" alt="">
							<div class="product-details">
								<a href="single-product-s5.jsp"><h6>Sandal Nữ Êmbrace Mint DPW071200XNG (Xanh Ngọc)</h6></a>
								<div class="price">
									<h6>421.000đ</h6>
								</div>
								<div class="prd-bottom">
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-product">
							<img class="img-fluid resize" src="../../../img/product/Nu/Sandal/s6.png" alt="">
							<div class="product-details">
								<a href="single-product-s6.jsp"><h6>Sandal Eva Phun Nữ Biti's Hunter DEWH01200KEM (Kem)</h6></a>
								<div class="price">
									<h6>452.000đ</h6>
									<!--										<h6 class="l-through">210.000đ</h6>-->
								</div>
